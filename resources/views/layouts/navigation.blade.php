            ...
            <div class="flex">
                @auth
                    ...
                    <!-- Logo -->
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('subscriber.plans')" :active="request()->routeIs('subscriber.plans')">
                                {{ __('Subscription Plans') }}
                            </x-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <x-nav-link :href="route('subscriber.payment.history')" :active="request()->routeIs('subscriber.payment.history')">
                                {{ __('Payment History') }}
                            </x-nav-link>
                        </div>
                    @endif
